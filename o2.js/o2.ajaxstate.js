 ...
 *
 *  lastModified: 2012-01-29 15:23:35.387389
 * -->
 *
...
(function(framework, window) {
     ...
     */
    me.addObserver = function(observer) {
     ...
     */
    me.deleteObserver = function(observer) {
     ...
     */
    me.timeoutObservers = function(observers, data) {
        var observer = null;
        var i = 0;
        var len = 0;
     ...
     * @param {Object} data - the data to pass to the <code>Observer</code>s.
     */
    me.timeoutAllObservers = function(data) {
